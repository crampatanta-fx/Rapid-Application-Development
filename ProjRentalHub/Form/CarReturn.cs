...
namespace ProjRentalHub
{
    ...
    {
        public CarReturn(string prmcarID)
        {
            InitializeComponent();
        ...
        private void pGoBackIcon_Click_1(object sender, EventArgs e)
        {
            this.Close();
        }
        ...
        private void CarReturn_Load(object sender, EventArgs e)
        {
            using (var context = new rentalHubDBContext())
            {
                ...
                if (car != null && car.status == "Available")
                {
                    ...
                    //DisableControls(this); // 'this' refers to the form instance
                    pGoBackIcon.Enabled = true;
                    btnReturn.Enabled = false;
                }
            }
        }
