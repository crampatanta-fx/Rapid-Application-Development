...
namespace ProjRentalHub
{
    public partial class MainForm : Form
    {
        ...
        public MainForm(string prmUserId)
        {
            InitializeComponent();
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            MainMenuTimer.Tick += DashboardTimer_Tick; // Subscribe to the Tick event
            MainMenuTimer.Start();
        }
        ...
        {
            CarManagement carManagement = new CarManagement("user", gUserId);
            carManagement.ShowDialog();
        }

        private void btnReturnCar_Click(object sender, EventArgs e)
        {
            ReturnMenu returnMenu = new ReturnMenu(gUserId);
            returnMenu.ShowDialog();
        }

        private void btnMyBookings_Click(object sender, EventArgs e)
        {
            MyBookings myBookings = new MyBookings(gUserId);
            myBookings.ShowDialog();
        }

        private void btnMyProfile_Click(object sender, EventArgs e)
        {
            CustomerMyProfile myProfile = new CustomerMyProfile(gUserId);
        ...
        private void btnCarStatusNext_Click_1(object sender, EventArgs e)
        {
            currentPage++;
            _ShowLiveCarStatus(currentPage);
        }

        private void btnCarStatusPrev_Click_1(object sender, EventArgs e)
        {
            if (currentPage > 1)
            {
                currentPage--;
